...
# efiiciency calculation using R^2 score = 1- (summation(y - y')^2 / summation(y - y")^2) , where y' is predicted values  & y is axtual values y" is mean value
y_train_pred = w_final * x_train_norm + b_final
